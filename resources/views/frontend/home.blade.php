...
<title>قالب اتاق اصناف شهرستان گرگان</title>
<meta content="قالب استاتیک HTML، CSS و JS برای اتاق اصناف شهرستان گرگان با تصاویر محلی، منوی بالای بهینه و منوی عمودی دارای زیرمنوی سمت چپ." name="description"/>
...
<a class="header-service-pill" href="#commissions">سامانه خدمات صنفی</a>
...
<ul class="top-submenu"><li><a href="#commissions">فهرست اتحادیه‌های صنفی</a></li><li><a href="#representatives">رسته‌های شغلی</a></li><li><a href="#friendship">اطلاعات تماس اتحادیه‌ها</a></li></ul>
</li>
<li class="nav-item top-nav-item has-top-submenu">
...
<ul class="top-submenu"><li><a href="#friendship">ثبت شکایت صنفی</a></li><li><a href="#friendship">گزارش تخلف</a></li><li><a href="#friendship">پیگیری بازرسی‌ها</a></li></ul>
</li>
<li class="nav-item top-nav-item has-top-submenu">
...
<ul class="top-submenu"><li><a href="#fractions">دوره‌های آموزشی</a></li><li><a href="#multimedia">بخشنامه‌ها و اطلاعیه‌ها</a></li><li><a href="#multimedia">اخبار اتاق اصناف</a></li></ul>
</li>
<li class="nav-item top-nav-item has-top-submenu">
<button aria-expanded="false" class="nav-link top-nav-link" type="button">سامانه‌ها<span class="top-submenu-caret"></span></button>
<ul class="top-submenu"><li><a href="#commissions">سامانه نوین اصناف</a></li><li><a href="#fractions">سامانه آموزش اصناف</a></li><li><a href="#multimedia">راهنمای خدمات الکترونیک</a></li></ul>
</li>
...
<input id="siteSearchInput" placeholder="عبارت مورد نظر را وارد کنید؛ مثل اتحادیه، پروانه کسب، شکایت، آموزش..." type="search"/>
...
<li><a href="{{ route('frontend.pages.show', 'services') }}">سامانه خدمات صنفی</a></li>
