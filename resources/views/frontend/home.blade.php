...
@foreach(['rep-production' => ['اتحادیه‌های تولیدی استان گلستان', 'map-img', 'production'], 'rep-distribution' => ['اتحادیه‌های توزیعی استان گلستان', 'map-img muted-map', 'distribution'], 'rep-service' => ['اتحادیه‌های خدماتی استان گلستان', 'map-img faded-map', 'service']] as $panel => $map)
