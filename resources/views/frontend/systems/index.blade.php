...
@section('title', 'سامانه‌ها | اتاق اصناف شهرستان گرگان')
@section('meta_description', 'لیست سامانه‌های پرکاربرد صنفی، خدمات الکترونیک و درگاه‌های مرتبط با اتاق اصناف شهرستان گرگان')
