<div class="admin-panel-card">
    <div class="row g-3">
        ...
        <div class="col-md-4"><label class="form-label" for="icon">آیکون</label><input class="form-control" id="icon" name="icon" value="{{ old('icon', $category?->icon) }}" placeholder="🏷️ یا کلاس آیکون"></div>
