...
<div class="col-md-6"><label class="form-label">تصویر جدید</label><input class="form-control" type="file" name="image" accept="image/*">@if($commission->image)<small><a href="{{ Storage::url($commission->image) }}" target="_blank">مشاهده تصویر فعلی</a></small>@endif</div>
