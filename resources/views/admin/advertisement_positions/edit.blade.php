...
<form class="admin-panel-card admin-form" action="{{ route('admin.advertisement_positions.update', $advertisementPosition) }}" method="POST">
    ...
    <div class="row g-3">
        ...
        <div class="col-12"><label class="form-label" for="description">توضیحات</label><textarea class="form-control" id="description" name="description" rows="4">{{ old('description', $advertisementPosition->description) }}</textarea></div>
    </div>
