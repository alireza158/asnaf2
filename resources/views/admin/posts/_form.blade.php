...
<div class="admin-panel-card">
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <input class="form-control" id="published_at" name="published_at" type="text" data-jalali-datepicker value="{{ jalali_input_datetime(old('published_at', $post?->published_at)) }}">
        </div>
        <div class="col-md-3">
