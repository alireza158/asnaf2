...
<div class="col-12"><label class="form-label">توضیحات فوتر</label><textarea class="form-control" name="footer_description" rows="4">{{ old('footer_description', $settings->get('footer.footer_description')) }}</textarea></div>
