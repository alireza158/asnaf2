...
@section('title', 'ایجاد پیام تبریک و تسلیت')

@section('content')
<div class="admin-page-toolbar"><div><p class="admin-eyebrow">پیام تبریک و تسلیت</p><h2>ایجاد پیام تبریک و تسلیت جدید</h2></div><a class="admin-secondary-btn" href="{{ route('admin.congratulation_messages.index') }}">بازگشت</a></div>
